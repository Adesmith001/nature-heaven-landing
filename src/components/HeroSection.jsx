...
const HeroSection = () => {
    return (
        <section className="relative min-h-screen bg-[#FCF5EB] overflow-hidden pt-24">
            ...
            <div className="absolute -bottom-20 left-0 w-100 h-100 pointer-events-none hidden md:block z-20">
            ...
            <div className="absolute -bottom-20 left-1/2 -translate-x-1/2 w-96 h-80 pointer-events-none hidden md:block z-20">
                <div className="relative w-full h-full">
            ...
            <div className="relative max-w-7xl mx-auto px-6 py-5 z-10">
                <div className="grid lg:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="flex flex-col gap-6 lg:hidden">
                        ...
                        <div className="w-full aspect-[4/3] rounded-2xl overflow-hidden">
                            <img src="/hero-section3.png" alt="Child" className="w-full h-full object-cover" />
                        </div>
                    </div>
                </div>
            </div>
